...
class MainActivity : AppCompatActivity(), View.OnClickListener {
     ...
     * `R.layout.activity_main` which consists of a `ConstraintLayout` holding a [TextView] with
     * ID `R.id.temperature` which we use to display the current temperature, an "Increase
     * Temperature" [Button] with id `R.id.increase_temp`, a 'Decrease Temperature" [Button] with
     * id `R.id.decrease_temp`, and an "Launch Slice Viewer" [Button] with id
     * `R.id.launch_slice_viewer_application`.
     *
     ...
     * descendant views).
     *
     * Having configured our content view we next initialize our [TextView] field
     * [temperatureTextView] by finding the view with ID `R.id.temperature`, initialize our
     * [String] field [sliceViewerPackageName] to the string with ID
     * `R.string.slice_viewer_application_package_name` from our resources (its value is
     * "com.example.android.sliceviewer"), and set the [View.OnClickListener] of all
